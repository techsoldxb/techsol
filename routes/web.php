...
//Route::get('/fb', 'HomeController@feedback')->name('fb');
...
Route::resource('/admin/cashpayment', 'Admin\CashpaymentController', ['as'=>'admin'])->middleware('auth');
...
//Invoiced
Route::resource('/job/jobinvoices', 'Job\JobinvoicesController', ['as'=>'job'])->middleware('auth');
...
Route::get('/fb', 'Job\FeedbackController@create')->name('fb');
...
Route::get('query1', 'AutoCompleteSearchController@index');
Route::get('autocomplete1', 'AutoCompleteSearchController@autocomplete1');



 Route::get('autocomplete', 'Pos\GrnController@autocomplete');
 Route::get('query', 'Pos\GrnController@index');
