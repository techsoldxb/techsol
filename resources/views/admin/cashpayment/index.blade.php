        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Cash Payment Details
                        <a href="{{ route('admin.cashpayment.create') }}" class="btn btn-primary btn-sm">Add</a></h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.cashpayment.edit',$c->th_tran_no) }}">
