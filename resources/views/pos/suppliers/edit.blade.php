...
<section class="content">
    <div class="container-fluid">
        <form class="needs-validation" novalidate method="POST" action="{{ route('job.jobfault.update', $fault->id) }}">
            @method('PUT')
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" name="exp_group_name"
                            placeholder="First name" value="{{ $faults->exp_group_name}}" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" name="exp_group_desc"
                            placeholder="First name" value="{{ $faults->exp_group_desc}}" required>
                        <div class="clear-fix"></div>
                    </div>
                </div>
