                             ...
                             <tfoot>
                                 <tr>
                                     ...
                                     <th class="font-weight-bold text-right">
                                         {{ number_format($topup_ob + $topup_cm,3) }} </th>
                                     <th class="font-weight-bold text-right">
                                         {{ number_format($paid + $advancepaid,3) }}</th>
                                     <th class="font-weight-bold text-right">
                                         {{ number_format($topup - $paid - $advancepaid,3) }} </th>
                         ...
                         <table class="table table-bordered">
                             ...
                             <tbody>
                                 <tr>
                                     ...
                                     <td>
                                         <input class="form-control text-center" type="text" name="fifty_qty"
                                             id="fifty_qty" onkeypress="return isNumberKey(event)" onkeyup="calc1()">
                                     </td>
                                     <td class="font-weight-bold text-right">
                                         <input class="form-control font-weight-bold text-center" type="text"
                                             name="fifty_amount" id="fifty_amount" disabled>
                                     </td>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <input class="form-control text-center" type="text" name="twenty_qty"
                                             id="twenty_qty" onkeypress="return isNumberKey(event)" onkeyup="calc1()">
                                     </td>
                                     <td class="font-weight-bold text-right">
                                         <input class="form-control font-weight-bold text-center" type="text"
                                             name="twenty_amount" id="twenty_amount" disabled>
                                     </td>
                                 ...
                                 <tr>
                                     ...
                                     <td class="font-weight-bold text-right">
                                         <input class="form-control font-weight-bold text-center" type="text"
                                             name="ten_amount" id="ten_amount" disabled>
                                     </td>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <input class="form-control text-center" type="text" name="five_qty"
                                             id="five_qty" onkeypress="return isNumberKey(event)" onkeyup="calc1()">
                                     </td>
                                     <td class="font-weight-bold text-right">
                                         <input class="form-control font-weight-bold text-center" type="text"
                                             name="five_amount" id="five_amount" disabled>
                                     </td>
                                 ...
                                 <tr>
                                     ...
                                     <td class="font-weight-bold text-right">
                                         <input class="form-control font-weight-bold text-center" type="text"
                                             name="one_amount" id="one_amount" disabled>
                                     </td>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <input class="form-control text-center" type="text" name="baisa_qty"
                                             id="baisa_qty" onkeypress="return isNumberKey(event)" onkeyup="calc1()">
                                     </td>
                                     <td class="font-weight-bold text-right">
                                         <input class="form-control font-weight-bold text-center" type="text"
                                             name="baisa_amount" id="baisa_amount" disabled>
                                     </td>
