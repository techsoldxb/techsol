...
<script>
  ...
  <div class="content-header">
    ...
    <section class="content">
     ...
     <form  class="needs-validation" name="myform" id="myform" novalidate method = "post" action="{{ route('hrms.survey.store') }}" 
      ...
      <div class = "clear-fix"></div>
              ...
              <div class="card bg-light text-dark">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      <div class = "row">
                      <label class = "col-lg-7" for="">2. Salaries are competitive compared to other similar organizations.</label>
                      <div class = "col-lg-3">    
