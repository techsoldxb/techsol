            ...
            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" id="validationCustom01" name="tb_cust_name"
                                value="{{ $jobcard->job_cust_name }}" disabled>
                        </div>
                        <label class="col" for="">Mobile Number</label>
                        <div class="col">
                            <input type="text" class="form-control" id="validationCustom02" name="tb_cust_addr"
                                value="{{ $jobcard->job_cust_mobile }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control datepicker" id="datepicker" name="tb_date"
                                value="{{ $jobcard->job_item_brand }}" disabled>
                        ...
                        <div class="col">
                            <input type="text" class="form-control" id="validationCustom02" name="tb_time"
                                value="{{ $jobcard->job_item_model }}" disabled>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" id="validationCustom02" name="tb_pay_mode"
                                value="{{ $jobcard->job_item_type }}" disabled>


                        </div>
                        <label class="col" for="">Job Type</label>
                        <div class="col">
                            <input type="text" class="form-control" id="validationCustom02" name="tb_reference"
                                value="{{ $jobcard->job_type }}" disabled>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" id="validationCustom02" name="tb_pay_mode"
                                value="{{ $jobcard->job_fault }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" id="validationCustom02" name="tb_pay_mode"
                                value="{{ $jobcard->job_remarks }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <ol>
                        ...
                        <li>In the event of late or non-payment of any amount owed by the customer or failure to collect
                            ...
                            not
                            be entertained.</li>
                        <li> On receipt of the device, the customer/person collects the device in required to inspect
                            and
