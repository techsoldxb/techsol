    ...
    <section class="content">
     ...
     <div class = "clear-fix"></div>
            ...
            <input type="email" class="form-control" value="{{ $jobcard->job_cust_email}}" id="validationCustom02" name="job_cust_email" placeholder="Enter Email" readonly>           
                  ...
                  <input type="text" class="form-control" onkeypress="return isNumberKey(event)" id="validationCustom02" name="job_invoice_amount" placeholder="Enter invoice amount">
                </div>
                          ...
                          <input type="text" class="form-control" id="validationCustom02" name="job_remark" placeholder="Enter the action remarks in detail">
