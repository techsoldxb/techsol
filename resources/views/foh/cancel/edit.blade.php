...
<script>
  ...
  <div class="content-header">
    ...
    <section class="content">
     ...
     action="{{ route('foh.cancel.update', $booking->id) }}">
     @method('PUT')
     ...
     <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class = "col">    
            <input type="text" class="form-control" id="validationCustom02" name="tb_cust_contact" value="{{ $booking->tb_cust_contact }}" disabled>
            </div>
            <label class = "col" for="">Category</label>
            <div class = "col">    
            <input type="text" class="form-control" id="validationCustom02" name="tb_category" value="{{ $booking->tb_category}}" disabled>           
            </div>     
            </div>
            </div>
                ...
                <input type="text" class="form-control" id="validationCustom02" name="tb_time" value="{{ $booking->tb_time }}" disabled>     
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                              ...
                              <tbody>
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          id="tb_student_qty" name="tb_student_qty" value="{{ $booking->tb_student_qty}}"  disabled>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control text-right" onkeypress="return isNumberKey(event)" onkeyup="calc1()"
                                          id="tb_student_price" name="tb_student_price" value="{{ number_format($booking->tb_student_price,3)}}"  disabled>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control text-right" onkeypress="return isNumberKey(event)" onkeyup="calc1()"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          id="tb_teacher_qty" name="tb_teacher_qty" value="{{ $booking->tb_teacher_qty}}" disabled>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control text-right" onkeypress="return isNumberKey(event)" onkeyup="calc2()"
                                          id="tb_teacher_price" name="tb_teacher_price" value="{{ number_format($booking->tb_teacher_price,3)}}" disabled>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          id="tb_adult_qty" name="tb_adult_qty" value="{{ $booking->tb_adult_qty}}" disabled>
                                        </td>
                                        <td>
                                          <input type="text" class="form-control text-right" onkeypress="return isNumberKey(event)" onkeyup="calc3()"
                                          id="tb_adult_price" name="tb_adult_price" value="{{ number_format($booking->tb_adult_price,3)}}" disabled>
                                        </td>
                                        <td>
                            ...
                            <div class="form-group">
                                <div class = "row">
                                <label class = "col-lg-1" for="">Cancel</label>
                                <div class = "col-lg-2">
                                  
                                  <input class="form-check-input" type="hidden"  Value = '0' name='tb_flex1'>    
                                  <input class="form-check-input" type="checkbox"  Value = '1' name='tb_flex1'>
                                ...
                                <label class = "col-lg-1" for="">Reason for Cancel</label>
                                <div class = "col-lg">    
                                  <input type="text" name = "tb_flex2" class = "form-control" placeholder="Enter the reason for Cancel">
                               </div>
                               ...
                               <div class="form-group">
                                ...
                                <a href="{{route('foh.cancel.index')}}" class="btn btn-warning" role="button">Cancel</a>
                                </div>
